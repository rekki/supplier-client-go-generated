...
type V3Order struct {
	...
	DeliveryAddress *V3DeliveryAddress `json:"delivery_address,omitempty"`
...
// SetDeliveryAddress gets a reference to the given V3DeliveryAddress and assigns it to the DeliveryAddress field.
...
func (o V3Order) MarshalJSON() ([]byte, error) {
...
type NullableV3Order struct {
	value *V3Order
	isSet bool
}

func (v NullableV3Order) Get() *V3Order {
	return v.value
}

func (v *NullableV3Order) Set(val *V3Order) {
	v.value = val
	v.isSet = true
}

func (v NullableV3Order) IsSet() bool {
	return v.isSet
}

func (v *NullableV3Order) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV3Order(val *V3Order) *NullableV3Order {
	return &NullableV3Order{value: val, isSet: true}
}

func (v NullableV3Order) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV3Order) UnmarshalJSON(src []byte) error {
	v.isSet = true
