...
func (o V3APISupplierCatalogUnit) MarshalJSON() ([]byte, error) {
...
type NullableV3APISupplierCatalogUnit struct {
	value *V3APISupplierCatalogUnit
	isSet bool
}

func (v NullableV3APISupplierCatalogUnit) Get() *V3APISupplierCatalogUnit {
	return v.value
}

func (v *NullableV3APISupplierCatalogUnit) Set(val *V3APISupplierCatalogUnit) {
	v.value = val
	v.isSet = true
}

func (v NullableV3APISupplierCatalogUnit) IsSet() bool {
	return v.isSet
}

func (v *NullableV3APISupplierCatalogUnit) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV3APISupplierCatalogUnit(val *V3APISupplierCatalogUnit) *NullableV3APISupplierCatalogUnit {
	return &NullableV3APISupplierCatalogUnit{value: val, isSet: true}
}

func (v NullableV3APISupplierCatalogUnit) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV3APISupplierCatalogUnit) UnmarshalJSON(src []byte) error {
	v.isSet = true
