...
// CatalogAllergen struct for CatalogAllergen
type CatalogAllergen struct {
...
func (o CatalogAllergen) MarshalJSON() ([]byte, error) {
...
type NullableCatalogAllergen struct {
	value *CatalogAllergen
	isSet bool
}

func (v NullableCatalogAllergen) Get() *CatalogAllergen {
	return v.value
}

func (v *NullableCatalogAllergen) Set(val *CatalogAllergen) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogAllergen) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogAllergen) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogAllergen(val *CatalogAllergen) *NullableCatalogAllergen {
	return &NullableCatalogAllergen{value: val, isSet: true}
}

func (v NullableCatalogAllergen) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogAllergen) UnmarshalJSON(src []byte) error {
	v.isSet = true
