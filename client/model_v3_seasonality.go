...
func (o V3Seasonality) MarshalJSON() ([]byte, error) {
...
type NullableV3Seasonality struct {
	value *V3Seasonality
	isSet bool
}

func (v NullableV3Seasonality) Get() *V3Seasonality {
	return v.value
}

func (v *NullableV3Seasonality) Set(val *V3Seasonality) {
	v.value = val
	v.isSet = true
}

func (v NullableV3Seasonality) IsSet() bool {
	return v.isSet
}

func (v *NullableV3Seasonality) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV3Seasonality(val *V3Seasonality) *NullableV3Seasonality {
	return &NullableV3Seasonality{value: val, isSet: true}
}

func (v NullableV3Seasonality) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV3Seasonality) UnmarshalJSON(src []byte) error {
	v.isSet = true
